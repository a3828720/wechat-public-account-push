...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx1309d86a7490a1d4',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'ba04e74eb904187caa4ab2cd03be41db',
  ...
  TIAN_API: {
    ...
    key: '3509ae1c8e7f099fca15a790b85a7f92',
  ...
  USERS: [
    {
      ...
      id: 'oExps65p8D02T6X4cy6GNJu_6tbo',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'y6lEfLPbeoKHjm9UtQ5WGQL3oQEkU3SosYKbyMSajrs',
      // 所在省份或城市，也可以不填
      province: '江苏',
      // 所在城市或县区
      city: '徐州',
      ...
      openUrl: 'https://xn--4gqpj668apte.cn/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '蛋蛋', year: '2007', date: '08-08',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2024-03-04' },
        // 结婚纪念日
    ...
    {
      name: '小杰',
      id: 'oExps6-8AkPnn5SDGlzseCbSYwTo',
      useTemplateId: '01K2xwQoY5y-YuDpzXTXRdD1Yqn2BymvzKiAvacQZ_A',
      province: '四川',
      city: '眉山',
      horoscopeDate: '08-09',
      horoscopeDateType: '今日',
  ...
  CALLBACK_TEMPLATE_ID: 'cA3mEyYlCm17p9pyDeQbv1g2TrFiAOtJbNc3EykezKc',
